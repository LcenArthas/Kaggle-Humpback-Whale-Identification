...
class MGN(nn.Module):
    def __init__(self, args):
        ...
        self.maxpool_zg_p1 = pool2d(kernel_size=(8, 24))              #before:4,12
        self.maxpool_zg_p2 = pool2d(kernel_size=(16, 48))             #before:8,24
        self.maxpool_zg_p3 = pool2d(kernel_size=(16, 48))             #before:8,24
        self.maxpool_zp2 = pool2d(kernel_size=(16, 24))               #before:8,12
        self.maxpool_zp3 = pool2d(kernel_size=(16, 16))               #before:8,8
